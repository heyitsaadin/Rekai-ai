...
def generate_image(prompt):
    ...
    return (
        ...
        f'<img src="{url}" alt="{prompt}" class="rekai-img loaded" style="opacity:1;" '
...
def generate_image_nvidia(prompt):
    ...
    try:
        ...
        if "data" in data and data["data"]:
            ...
            html = (
                f'<div class="rekai-img-wrap">'
                f'<img src="{src}" alt="{prompt}" class="rekai-img loaded" style="opacity:1;" '
                f'onerror="this.style.display=\'none\'">'
                f'<div class="rekai-img-footer">'
                f'<span class="rekai-img-caption">🎨 {prompt} ✨</span>'
...
def share_chat():
    ...
    for m in msgs:
        ...
        if txt.startswith("[IMAGE GENERATED:"):
            ...
            txt = f'<div class="rekai-img-wrap"><img src="{img_url}" alt="{prompt_text}" class="rekai-img loaded" style="opacity:1;"><div class="rekai-img-footer"><span class="rekai-img-caption">🎨 {prompt_text} ✨</span></div></div>'
