...
def generate_image(prompt):
    ...
    url = f"https://image.pollinations.ai/prompt/{safe_prompt}?width=768&height=768&nologo=true&enhance=true&model=flux&seed={seed}"
    ...
    return (
        ...
        f'<span class="jarvis-img-caption">\U0001f3a8 {prompt}</span>'
